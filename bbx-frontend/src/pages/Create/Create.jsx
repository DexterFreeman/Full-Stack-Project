        ...
        <Container>
         <form onSubmit={handleSubmit}>
          ...
          <div className="create-page__inputsContainer">
              ...
              <input type="text" required id="name" value={name} onChange={(e) => {setName(e.target.value)}}></input>
              <label for="nationality">Nationality</label>
              <input type="text" required id="nationality" value={nationality} onChange={(e) => {setNationality(e.target.value)}}></input>
              <label for="realName">Real name</label>
              <input type="text" id="realName" value={realName} onChange={(e) => {setRealName(e.target.value)}}></input>
              <label for="desc">Description</label>
              <input type="text" id="desc" value={description} onChange={(e) => {setDescription(e.target.value)}}></input>
          </div>
          <div className="create-page__inputsContainer">
            <label for="image">Image</label>
            <input type="text" required id="image" value={image} onChange={(e) => {setImage(e.target.value)}}/>
              <label for="sounds">Sounds</label>
              <input type="text" required id="sounds" value={sounds} onChange={(e) => {setSounds(e.target.value)}}></input>
              <label for="video">Feature Video Embed</label>
              <input type="text" required id="video" value={featureVideo} onChange={(e) => {setFeatureVideo(e.target.value)}}></input>
          </div>
